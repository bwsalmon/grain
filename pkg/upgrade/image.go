...
//
// A deployment installed by scripts/setup.sh no longer builds a
...
type ImageConfig struct {
	...
	// ExecStart (scripts/setup.sh's write_systemd_units). The
	...
	// own ENTRYPOINT is `grain` (Dockerfile), so appending
