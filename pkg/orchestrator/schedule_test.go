...
func filedSuiteSchedule(t *testing.T, store *model.Store, id string, nextRunAt time.Time) (model.TaskSuite, model.ScheduledTask) {
	t.Helper()
	ctx := t.Context()
...
// fireScheduledSuite's own defensive path, fireScheduledTask's
