...
// is handed no Runner. v2 has no host adapter yet (see README.md),
...
type CapabilitySpec struct {
	...
	// it is exactly what a deployment's secret store (see secrets)
...
// README.md), it just refuses to paper over the failure by
