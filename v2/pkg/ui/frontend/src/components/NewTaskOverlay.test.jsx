...
describe("NewTaskOverlay", () => {
  ...
  it("parses comma-separated depends-on ids and read-only repos, and includes checked capabilities", async () => {
    ...
    await user.type(screen.getByLabelText(/Depends on/), " 12 ,15,15 ");
    ...
    expect(payload.dependsOn).toEqual(["12", "15", "15"]);
