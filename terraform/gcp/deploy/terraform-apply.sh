...
redact() {
  awk '
    ...
    /"(grain-github-token|grain-github-app-id|grain-github-app-installation-id|grain-github-app-private-key|grain-gemini-api-key|grain-claude-oauth-token|grain-openai-api-key|grain-secrets-key|grain-gcp-minter-key)"/ && / = "/ {
