...
func TestDispatchPreClonesTheRepoSoTheAgentNeverHasTo(t *testing.T) {
	...
	if prompt := orchestrator.BuildPrompt(*full, orchestrator.CheckoutDir, false, orchestrator.DefaultMaxRunRuntime); !strings.Contains(prompt, "./"+orchestrator.CheckoutDir) {
